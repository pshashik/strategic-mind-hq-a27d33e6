...
export const COUNTRY_DATABASE: CountryLexiconEntry[] = [
  ...
  { code2: "AR", code3: "ARG", name: "Argentina", region: "South America", pattern: /\b(argentina|argentine|buenos aires)\b/gi },
  { code2: "BD", code3: "BGD", name: "Bangladesh", region: "Asia-Pacific", pattern: /\b(bangladesh|bangladeshi|dhaka)\b/gi },
  { code2: "BE", code3: "BEL", name: "Belgium", region: "Europe", pattern: /\b(belgium|belgian|brussels)\b/gi },
  { code2: "BO", code3: "BOL", name: "Bolivia", region: "South America", pattern: /\b(bolivia|bolivian|la paz)\b/gi },
  { code2: "CL", code3: "CHL", name: "Chile", region: "South America", pattern: /\b(chile|chilean|santiago)\b/gi },
  { code2: "CO", code3: "COL", name: "Colombia", region: "South America", pattern: /\b(colombia|colombian|bogota)\b/gi },
  { code2: "CU", code3: "CUB", name: "Cuba", region: "North America", pattern: /\b(cuba|cuban|havana)\b/gi },
  { code2: "DK", code3: "DNK", name: "Denmark", region: "Europe", pattern: /\b(denmark|danish|copenhagen)\b/gi },
  { code2: "FI", code3: "FIN", name: "Finland", region: "Europe", pattern: /\b(finland|finnish|helsinki)\b/gi },
  { code2: "GE", code3: "GEO", name: "Georgia", region: "Eurasia", pattern: /\b(georgia|georgian|tbilisi)\b/gi },
  { code2: "GR", code3: "GRC", name: "Greece", region: "Europe", pattern: /\b(greece|greek|athens)\b/gi },
  { code2: "ID", code3: "IDN", name: "Indonesia", region: "Asia-Pacific", pattern: /\b(indonesia|indonesian|jakarta)\b/gi },
  { code2: "IE", code3: "IRL", name: "Ireland", region: "Europe", pattern: /\b(ireland|irish|dublin)\b/gi },
  { code2: "JO", code3: "JOR", name: "Jordan", region: "Middle East", pattern: /\b(jordan|jordanian|amman)\b/gi },
  { code2: "KE", code3: "KEN", name: "Kenya", region: "Africa", pattern: /\b(kenya|kenyan|nairobi)\b/gi },
  { code2: "KW", code3: "KWT", name: "Kuwait", region: "Middle East", pattern: /\b(kuwait|kuwaiti)\b/gi },
  { code2: "LY", code3: "LBY", name: "Libya", region: "Africa", pattern: /\b(libya|libyan|tripoli)\b/gi },
  { code2: "MA", code3: "MAR", name: "Morocco", region: "Africa", pattern: /\b(morocco|moroccan|rabat)\b/gi },
  { code2: "MM", code3: "MMR", name: "Myanmar", region: "Asia-Pacific", pattern: /\b(myanmar|burma|burmese|naypyidaw)\b/gi },
  { code2: "MY", code3: "MYS", name: "Malaysia", region: "Asia-Pacific", pattern: /\b(malaysia|malaysian|kuala lumpur)\b/gi },
  { code2: "NL", code3: "NLD", name: "Netherlands", region: "Europe", pattern: /\b(netherlands|dutch|amsterdam|the hague)\b/gi },
  { code2: "NO", code3: "NOR", name: "Norway", region: "Europe", pattern: /\b(norway|norwegian|oslo)\b/gi },
  { code2: "NZ", code3: "NZL", name: "New Zealand", region: "Asia-Pacific", pattern: /\b(new zealand|new zealander|wellington)\b/gi },
  { code2: "OM", code3: "OMN", name: "Oman", region: "Middle East", pattern: /\b(oman|omani|muscat)\b/gi },
  { code2: "PE", code3: "PER", name: "Peru", region: "South America", pattern: /\b(peru|peruvian|lima)\b/gi },
  { code2: "PH", code3: "PHL", name: "Philippines", region: "Asia-Pacific", pattern: /\b(philippines|philippine|filipino|manila)\b/gi },
  { code2: "QA", code3: "QAT", name: "Qatar", region: "Middle East", pattern: /\b(qatar|qatari|doha)\b/gi },
  { code2: "RO", code3: "ROU", name: "Romania", region: "Europe", pattern: /\b(romania|romanian|bucharest)\b/gi },
  { code2: "RS", code3: "SRB", name: "Serbia", region: "Europe", pattern: /\b(serbia|serbian|belgrade)\b/gi },
  { code2: "SE", code3: "SWE", name: "Sweden", region: "Europe", pattern: /\b(sweden|swedish|stockholm)\b/gi },
  { code2: "SG", code3: "SGP", name: "Singapore", region: "Asia-Pacific", pattern: /\b(singapore|singaporean)\b/gi },
  { code2: "TH", code3: "THA", name: "Thailand", region: "Asia-Pacific", pattern: /\b(thailand|thai|bangkok)\b/gi },
  { code2: "UG", code3: "UGA", name: "Uganda", region: "Africa", pattern: /\b(uganda|ugandan|kampala)\b/gi },
  { code2: "AE", code3: "ARE", name: "United Arab Emirates", region: "Middle East", pattern: /\b(united arab emirates|uae|emirati|abu dhabi|dubai)\b/gi },
  { code2: "VN", code3: "VNM", name: "Vietnam", region: "Asia-Pacific", pattern: /\b(vietnam|vietnamese|hanoi)\b/gi },
  { code2: "ZW", code3: "ZWE", name: "Zimbabwe", region: "Africa", pattern: /\b(zimbabwe|zimbabwean|harare)\b/gi },
];
